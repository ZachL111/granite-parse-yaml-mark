...
granite-parse-yaml-mark is a Ruby project for parsers. It focuses on this technical goal: Implement a Ruby parsers project for yaml policy evaluation, using deny and allow fixtures and explainable decision traces.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 172, risk penalty 4, latency penalty 4, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
