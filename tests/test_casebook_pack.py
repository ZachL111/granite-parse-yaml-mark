"""Regression checks for the granite-parse-yaml-mark casebook."""
...
from casebook.harness import assert_expected, granite_parse_yaml_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_parse_yaml_mark_summary(), assert_expected())
